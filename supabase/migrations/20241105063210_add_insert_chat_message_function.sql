...
BEGIN
    ...
    IF chat_data ? 'gift' THEN
        ...
        -- Insert into gifts table, linking to greeting_card if available
    ...
    -- Insert into chat_messages table, linking to gift_id and conversation_id
