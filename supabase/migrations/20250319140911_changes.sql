alter table "public"."gift_cards" drop constraint "gift_cards_gift_id_key";

alter table "public"."gift_cards" drop constraint "public_gift_cards_gift_id_fkey";

drop index if exists "public"."gift_cards_gift_id_key";

alter table "public"."gift_cards" drop column "card_design_url";

alter table "public"."gift_cards" drop column "created_at";

alter table "public"."gift_cards" drop column "gift_id";

alter table "public"."gift_cards" drop column "is_activated";

alter table "public"."gift_cards" drop column "title";

alter table "public"."gift_cards" add column "amount" double precision not null;

alter table "public"."gift_cards" add column "currency" text not null default 'nok'::text;

alter table "public"."gift_cards" add column "retailer" text;

alter table "public"."gift_messages" disable row level security;
