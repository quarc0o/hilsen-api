drop function if exists "public"."get_conversation_by_id"(p_conversation_id uuid);

drop function if exists "public"."get_user_conversations"(conversation_ids uuid[]);
